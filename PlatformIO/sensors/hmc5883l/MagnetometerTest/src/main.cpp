...
const gpio_num_t PIN_MPU_SDA = GPIO_NUM_33;  // SDA do MPU-6050
const gpio_num_t PIN_MPU_SCL = GPIO_NUM_32;  // SCL do MPU-6050
...
void setup()
{
    ...
    error = compass.setScale(MAGNETOMETER_SCALE_1_3); // Set the scale of the compass.

...
void HMC5883L::initCompass()
{
    ...
    int error = setScale(MAGNETOMETER_SCALE_1_3);                              // Set the scale of the compass.
...
short HMC5883L::setScale(MagnetometerScale_e gauss)
{
    uint8_t regValue = 0x00;

    switch(gauss)
    {
        case MAGNETOMETER_SCALE_0_88:
            regValue = 0x00;
            m_Scale = 0.73;
            break;
        case MAGNETOMETER_SCALE_1_3:
            regValue = 0x01;
            m_Scale = 0.92;
            break;
        case MAGNETOMETER_SCALE_1_9:
            regValue = 0x02;
            m_Scale = 1.22;
            break;
        case MAGNETOMETER_SCALE_2_5:
            regValue = 0x03;
            m_Scale = 1.52;
            break;
        case MAGNETOMETER_SCALE_4_0:
            regValue = 0x04;
            m_Scale = 2.27;
            break;
        case MAGNETOMETER_SCALE_4_7:
            regValue = 0x05;
            m_Scale = 2.56;
            break;
        case MAGNETOMETER_SCALE_5_6:
            regValue = 0x06;
            m_Scale = 3.03;
            break;
        case MAGNETOMETER_SCALE_8_1:
            regValue = 0x07;
            m_Scale = 4.35;
            break;
        default:
